...
def where_am_i():
    ...
    if distance_from_oregon > 1300 and distance_from_oregon < 1501:
        place = "Missouri"

    if distance_from_oregon > 1000 and distance_from_oregon < 1300 :
        place = "Kansas"

    if distance_from_oregon > 750 and distance_from_oregon < 1000 :
        place = "Nebraska"

    if distance_from_oregon > 200 and distance_from_oregon < 750 :
        place = "Wyoming"

    if distance_from_oregon > -100 and distance_from_oregon < 200:
        place = "Idaho"


def credits():
  # These are the credits
  print(f"\nMade by Matthew Brittain\nlast update on 04/01w/2024, Version {version}\nIspired by The Oregon Trail game\nMade with 267 lines of code!")
  time.sleep(1)
  print("\n\nBeta testers:\nSimon McCann\nOdin Kelly\nVincent Knowlmayer\nDymion Cherry\nPreston Bloodhart")
...
if p_from == "1":
    print(f"Hello {p_name} from {p_from} you have 2000 dollars")
    money = 2000

if p_from == "2":
    print(f"Hello {p_name} from {p_from} you have 1500 dollars")
    money = 1500

if p_from == "3":
    print(f"Hello {p_name} from {p_from} you have 1750 dollars")
    money = 1750
    print("\n\n")
time.sleep(1)
shop_open()
